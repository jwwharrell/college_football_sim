...
Define versioned, reproducible calibration and aggregate validation for the possession-level simulation so statistical behavior remains realistic, explainable, and stable across development and release checks.
